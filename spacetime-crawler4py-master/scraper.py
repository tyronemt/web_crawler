...
def extract_next_links(url, resp):
    ...
    if is_valid(url) and if_not_crawled(url) and valid_response_status(resp):
        ...
        sloup = BeautifulSoup(html_content, "html.parser") #https://python.gotrained.com/beautifulsoup-extracting-urls/ implemented the algorithm to extract links using beautiful soup from this source
